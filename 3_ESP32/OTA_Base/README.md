...
```C++
  ...
  const char* AUTH_PASSWORD = "your_authentication_password"
  const char* HOST = "unique_name" // Used to easily find your wifi board
  const int IP = 100; // Static IP address
```
